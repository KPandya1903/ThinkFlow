...
export default function SignInPage() {
  return (
    <main className="min-h-screen flex items-center justify-center px-4 py-12 relative">
      ...
      <div
        className="absolute top-1/3 left-1/4 w-[400px] h-[400px] rounded-full bg-primary/8 blur-[120px] pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-card rounded-2xl p-8 hover:transform-none">
          <h1 className="text-2xl font-bold text-txt text-center mb-2">Welcome Back</h1>
          ...
          <p className="text-center text-sm text-txt-secondary mt-6">
            ...
            <Link href="/sign-up" className="text-primary-light hover:text-primary font-semibold transition-colors">
              Sign up
            </Link>
          </p>
        </div>
